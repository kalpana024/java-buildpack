...
Function printData(objItem)
  Wscript.Echo objItem.ConnectionFailures & " " & objItem.ConnectionsActive & " " & objItem.ConnectionsEstablished & " " & objItem.ConnectionsPassive & " " & objItem.ConnectionsReset & " " & objItem.SegmentsPersec & " " & objItem.SegmentsReceivedPersec & " " & objItem.SegmentsRetransmittedPersec & " " & objItem.SegmentsSentPersec & vbCrlf
End Function
