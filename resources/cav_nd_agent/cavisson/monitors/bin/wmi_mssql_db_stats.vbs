...
Set colItems = objRefresher.AddEnum(objWMIService, _
    "Win32_PerfFormattedData_MSSQLSTOREDB_MSSQLSTOREDBDatabases").objectSet
...
Function printData(objItem)
  ...
  if NOT (objItem.Name = "") then
    vectorName = Replace(objItem.Name, " ","_")
    Wscript.Echo getVectorID(vectorName) & ":" & vectorName & "|" &  objItem.ActiveTransactions & " " & objItem.LogGrowths & " " & objItem.BackupPerRestoreThroughputPersec & " " & objItem.BulkCopyRowsPersec & " " & objItem.BulkCopyThroughputPersec & " " & objItem.DataFilesSizeKB & " " & objItem.DBCCLogicalScanBytesPersec & " " & objItem.LogCacheReadsPersec & " " & objItem.LogFilesSizeKB & " " & objItem.LogFilesUsedSizeKB & " " & objItem.LogFlushesPersec & " " & objItem.LogFlushWaitsPersec & " " & objItem.LogFlushWaitTime & " " & objItem.LogFlushWriteTimems & " " & objItem.LogPoolCacheMissesPersec & " " & objItem.LogPoolDiskReadsPersec & " " & objItem.LogPoolRequestsPersec & " " & objItem.TransactionsPersec & " " & objItem.TrackedtransactionsPersec & " " & objItem.WriteTransactionsPersec  & vbCrlf
  End If
End Function
