...
Function printData(dataobjItem)
  ...
  if NOT (dataobjItem.Name = "") then
    ...
    IF (processIdCmdArgsMap.Exists(processid)) then
         ...
         End if
    End if 
    Wscript.Echo getVectorID(vectorName) & ":" & vectorName & "|" & dataobjItem.NumberLinkTimeChecks & " " & dataobjItem.PercentTimeinRTchecks & " " & dataobjItem.PercentTimeSigAuthenticating & " " & dataobjItem.StackWalkDepth & " " & dataobjItem.TotalRuntimeChecks & vbCrlf
  End If
End Function
