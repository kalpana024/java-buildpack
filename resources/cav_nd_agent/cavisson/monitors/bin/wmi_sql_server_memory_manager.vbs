...
Rem @Description - This script is used to get statistics of sql server memory manager.
Rem @GDF - cm_win_sql_server_memorymanager.gdf
Rem Monitor Syntax - STANDARD_MONITOR  QA_Tier>WINTESTENV QA_Tier>WINTESTENV SQLServerMemoryManager
Rem --------------------------------------------------------------------------------------------------------
...
Set colItems = objRefresher.AddEnum(objWMIService, _
    "Win32_PerfFormattedData_MSSQLSERVER_SQLServerMemoryManager").objectSet
...
Function printData(objItem)
  Wscript.Echo objItem.ConnectionMemoryKB & " " & objItem.GrantedWorkspaceMemoryKB  & " " & objItem.LockBlocks & " " & objItem.LockBlocksAllocated & " " & objItem.LockMemoryKB & " " & objItem.LockOwnerBlocks & " " & objItem.LockOwnerBlocksAllocated & " " & objItem.MaximumWorkspaceMemoryKB & " " & objItem.MemoryGrantsOutstanding & " " & objItem.MemoryGrantsPending & " " & objItem.OptimizerMemoryKB & " " & objItem.SQLCacheMemoryKB & " " & objItem.TargetServerMemoryKB & " " & objItem.TotalServerMemoryKB & vbCrlf
End Function
