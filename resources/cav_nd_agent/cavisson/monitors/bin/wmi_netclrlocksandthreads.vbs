...
Rem Object used to get data for .NET application Process.
...
Function printData(dataobjItem)
  ...
  if NOT (dataobjItem.Name = "") then
    ...
    IF (processIdCmdArgsMap.Exists(processid)) then
         ...
         End if
    End if 
    Wscript.Echo getVectorID(vectorName) & ":" & vectorName & "|" & dataobjItem.ContentionRatePersec & " " & dataobjItem.CurrentQueueLength & " " & dataobjItem.NumberofcurrentlogicalThreads & " " & dataobjItem.NumberofcurrentphysicalThreads & " " & dataobjItem.Numberofcurrentrecognizedthreads  & " " & dataobjItem.Numberoftotalrecognizedthreads & " " & dataobjItem.QueueLengthPeak & " " & dataobjItem.QueueLengthPersec & " " & dataobjItem.rateofrecognizedthreadsPersec & " " & dataobjItem.TotalNumberofContentions & vbCrlf
  End If
End Function
