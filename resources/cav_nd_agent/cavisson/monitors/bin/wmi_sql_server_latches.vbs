...
Rem @Description - Collects statistics associated with internal server latches
Rem @GDF - cm_win_sql_server_latches.gdf
Rem Monitor Syntax - STANDARD_MONITOR QA_Tier>WINTESTENV QA_Tier>WINTESTENV SQLServerLatches
Rem------------------------------------------------------------------------------------------- 
...
Set colItems = objRefresher.AddEnum(objWMIService, _
    "Win32_PerfFormattedData_MSSQLSERVER_SQLServerLatches").objectSet
...
Function printData(objItem)
  Wscript.Echo objItem.AverageLatchWaitTimems & " " & objItem.LatchWaitsPersec & " " & objItem.NumberofSuperLatches & " " & objItem.SuperLatchDemotionsPersec & " " & objItem.SuperLatchPromotionsPersec & " " & objItem.TotalLatchWaitTimems & vbCrlf
End Function
