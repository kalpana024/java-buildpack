...
Set colItems = objRefresher.AddEnum(objWMIService, _
    "Win32_PerfFormattedData_MSSQLSERVER_SQLServerGeneralStatistics").objectSet
...
Function printData(objItem)
  Wscript.Echo objItem.UserConnections & " " & objItem.LoginsPersec & " " & objItem.LogoutsPersec & vbCrlf
End Function
