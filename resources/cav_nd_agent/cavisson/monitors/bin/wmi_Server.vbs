...
Function printData(objItem)
  Wscript.Echo objItem.BlockingRequestsRejected & " " & objItem.BytesReceivedPersec & " " & objItem.BytesTotalPersec  & " " & objItem.BytesTransmittedPersec  & " " & objItem.ContextBlocksQueuedPersec & " " & objItem.LogonPersec  & " " & objItem.LogonTotal   & " " & objItem.PoolNonpagedBytes & " " & objItem.PoolNonpagedFailures & " "& objItem.PoolNonpagedPeak & " " & objItem.PoolPagedBytes & " " & objItem.PoolPagedFailures & " " & objItem.PoolPagedPeak & " " & objItem.ServerSessions & " " & objItem.SessionsErroredOut & " " & objItem.SessionsForcedOff & " " & objItem.SessionsLoggedOff & " " & objItem.SessionsTimedOut & vbCrlf
End Function
