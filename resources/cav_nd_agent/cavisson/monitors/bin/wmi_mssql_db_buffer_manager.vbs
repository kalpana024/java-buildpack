...
Rem @GDF - cm_win_mssql_db_buffermanager.gdf
Rem @Description - This script is used to get usage Memory to store data pages, physical I/O as SQL Server reads and writes database pages..
Rem @Monitor Syntax - STANDARD_MONITOR QA_Tier>WINTESTENV QA_Tier>WINTESTENV MSSQLDBBufferManagerStats
Rem --------------------------------------------------------------------------------------------------------------------
...
Set colItems = objRefresher.AddEnum(objWMIService, _
    "Win32_PerfFormattedData_MSSQLSTOREDB_MSSQLSTOREDBBufferManager").objectSet
...
Function printData(objItem)
  Wscript.Echo objItem.Buffercachehitratio & " " & objItem.CheckpointpagesPersec & " " & objItem.Databasepages & " " & objItem.Extensionallocatedpages & " " & objItem.Extensionfreepages  & " " & objItem.ExtensionpageevictionsPersec  & " " & objItem.ExtensionpagereadsPersec & " " & objItem.ExtensionpagewritesPersec  & " " & objItem.PagereadsPersec   & " " & objItem.PagewritesPersec & " " & objItem.ReadaheadpagesPersec & vbCrlf
