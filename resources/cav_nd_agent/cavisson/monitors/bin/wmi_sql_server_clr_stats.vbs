...
Rem @Description - This script provides the stats for SQL server class loader.
Rem @Monitor Syntax - STANDARD_MONITOR QA_Tier>WINTESTENV QA_Tier>WINTESTENV SQLServerCLRStats
Rem @GDF - cm_win_sql_server_clr_stats.gdf
Rem -----------------------------------------------------------------------------------------------------
...
Set colItems = objRefresher.AddEnum(objWMIService, _
    "Win32_PerfFormattedData_MSSQLSERVER_SQLServerCLR").objectSet
...
Rem convert value from micro second to milli seconds
const microToMS = 1000
...
Function printData(objItem)
  Wscript.Echo Round((objItem.CLRExecution/microToMS),3) & vbCrlf
End Function
