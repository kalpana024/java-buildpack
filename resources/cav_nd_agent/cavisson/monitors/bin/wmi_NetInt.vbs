...
Function printData(objItem)
  ...
  if NOT (objItem.Name = "") then
    vectorName = Replace(objItem.Name, " ","_")
    Wscript.Echo getVectorID(vectorName) & ":" & vectorName & "|" & objItem.BytesReceivedPersec  & " " & objItem.BytesSentPersec & " " & objItem.BytesTotalPersec  & " " & objItem.CurrentBandwidth  & " " & objItem.OffloadedConnections & " " & objItem.OutputQueueLength & " " & objItem.PacketsOutboundErrors & " " & objItem.PacketsReceivedPersec & " " & objItem.PacketsSentPersec & " " & objItem.PacketsPersec & vbCrlf
  End If
End Function
