...
Rem @GDF - cm_win_Cache.gdf
Rem @Description - This script is used to get metrics File system cache is an area of physical memory that stores recently used data until the memory is required for other purposes.
Rem @Monitor Syntax - STANDARD_MONITOR QA_Tier>WINTESTENV QA_Tier>WINTESTENV CacheStats
Rem --------------------------------------------------------------------------------------------------------------------
...
Set colItems = objRefresher.AddEnum(objWMIService, _
    "Win32_PerfFormattedData_PerfOS_Cache").objectSet
...
Function printData(objItem)
  Wscript.Echo objItem.AsyncCopyReadsPersec & " " & objItem.AsyncDataMapsPersec & " " & objItem.AsyncFastReadsPersec  & " " & objItem.AsyncMDLReadsPersec  & " " & objItem.AsyncPinReadsPersec & " " & objItem. CopyReadHitsPercent  & " " & objItem.CopyReadsPersec   & " " & objItem.DataFlushesPersec & " " & objItem.DataFlushPagesPersec & " "& objItem.DataMapHitsPercent & " " & objItem.DataMapPinsPersec & " " & objItem.DataMapsPersec & " " & objItem.DirtyPages & " " & objItem.DirtyPageThreshold & " " & objItem.FastReadNotPossiblesPersec & " " & objItem.FastReadResourceMissesPersec & " " & objItem.FastReadsPersec & " " & objItem.LazyWriteFlushesPersec & " " & objItem.LazyWritePagesPersec& " " & objItem.MDLReadHitsPercent & " " & objItem.MDLReadsPersec & " " & objItem.PinReadHitsPercent  & " " & objItem.PinReadsPersec & " " & objItem.ReadAheadsPersec& " " & objItem.SyncCopyReadsPersec & " " & objItem.SyncDataMapsPersec & " " & objItem.SyncFastReadsPersec & " " & objItem.SyncMDLReadsPersec & " " & objItem.SyncPinReadsPersec & vbCrlf
