...
Set colItems = objRefresher.AddEnum(objWMIService, _
    "Win32_PerfFormattedData_ASPNET_64_2050727_ASPNETAppsv2050727").objectSet
...
do While True
  ...
  For Each objItem in colItems
     Wscript.Echo objItem.RequestsExecuting & " " & objItem.RequestsRejected & " " & objItem.RequestsPerSec & " " & objItem.RequestExecutionTime
