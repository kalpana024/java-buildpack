...
Set colItems = objRefresher.AddEnum(objWMIService, _
    "Win32_PerfFormattedData_MSSQLSTOREDB_MSSQLSTOREDBPlanCache").objectSet
...
Function printData(objItem)
  ...
  if NOT (objItem.Name = "") then
    vectorName = Replace(objItem.Name, " ","_")
    Wscript.Echo getVectorID(vectorName) & ":" & vectorName & "|" & objItem.CacheHitRatio & " " & objItem.CacheObjectCounts & " " & objItem.CachePages & " " & objItem.CacheObjectsinuse & vbCrlf
  End If
End Function
