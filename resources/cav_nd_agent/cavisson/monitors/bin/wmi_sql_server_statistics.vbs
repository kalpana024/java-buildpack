...
Set colItems = objRefresher.AddEnum(objWMIService, _
    "Win32_PerfFormattedData_MSSQLSERVER_SQLServerSQLStatistics").objectSet
...
Function printData(objItem)
  Wscript.Echo objItem.SQLCompilationsPersec & " " & objItem.SQLReCompilationsPersec & " " & objItem.BatchRequestsPersec & vbCrlf
End Function
