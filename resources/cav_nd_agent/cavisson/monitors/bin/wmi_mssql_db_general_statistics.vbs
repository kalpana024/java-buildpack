...
Rem @GDF - cm_win_sql_server_general_statistics.gdf
Rem @Mon_Syntx - STANDARD_MONITOR QA_Tier>WINTESTENV QA_Tier>WINTESTENV SQLServerGeneralStatistics
Rem-----------------------------------------------------------------------------------------------
...
Set colItems = objRefresher.AddEnum(objWMIService, _
    "Win32_PerfFormattedData_MSSQLSTOREDB_MSSQLSTOREDBGeneralStatistics").objectSet
...
Function printData(objItem)
  Wscript.Echo objItem.UserConnections & " " & objItem.LoginsPersec & " " & objItem.LogoutsPersec & " " & objItem.LogicalConnections & " " & objItem.MarsDeadlocks & " " & objItem.Processesblocked & " " & objItem.Transactions & vbCrlf
End Function
