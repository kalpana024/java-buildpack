...
Function printData(dataobjItem)
  ...
  if NOT (dataobjItem.Name = "") then
    ...
    IF (processIdCmdArgsMap.Exists(processid)) then
         ...
         End if
    End if 
    Wscript.Echo getVectorID(vectorName) & ":" & vectorName & "|" & dataobjItem.NumberofExcepsThrownPersec & " " & dataobjItem.NumberofFiltersPersec & " " & dataobjItem.NumberofFinallysPersec & " " & dataobjItem.ThrowToCatchDepthPersec & vbCrlf
  End If
End Function
